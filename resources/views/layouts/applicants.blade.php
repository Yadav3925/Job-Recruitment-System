				...
				<div class="card">
					...
					<div class="card-body">
                       ...
                       @if($user->currentPage() > 1)
                             <a href="{{ $user->previousPageUrl() }}">Previous</a>
                           @endif
	 ...
	 <input type="hidden" class="form-control"  id="id" name="id" >
		<div class="row form-group">
			<div class="col-md-12">
				...
				<textarea name="cover_letter" id="cover_letter" cols="30" rows="3" placeholder="Message To the applicant" class="form-control"></textarea>
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-12">
